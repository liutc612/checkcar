...
<script>
	...
	$(function(){
		$.ajax({
			url:"../FindCarinfoServlet.do?key=mcn",
			type:"get",
			dataType:"json",
			success:function(carNum){
				$("#carNumber").autocomplete(carNum,{
					max:10,
...
<body background="../images/bgimg.png">
	<form action="../AddCarinfoServlet.do" method="post">
		<div class="place">
			<span>位置：</span>
			<ul class="placeul">
				<li>首页</li>
		...
		<div>
			<table>
				<tr>
					...
					<td align="center"><input type="text" name="carNumber" id="carNumber"/></td>
					<td align="right">汽车类型</td>
					<td align="center"><input type="text" name="carStyle"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center"><input type="text" name="carYearCheck" onfocus="WdatePicker({isShowClear:false,readOnly:true})"/></td>
					<td align="right">技术等级</td>
					<td align="center"><input type="text" name="technologyLevel" onfocus="WdatePicker({isShowClear:false,readOnly:true})"/></td>
				</tr>
				<tr>
					<td align="right">二级维护</td>
					<td align="center"><input type="text" name="towLevel" onfocus="WdatePicker({isShowClear:false,readOnly:true})"/></td>
					<td align="right">强制保险</td>
					<td align="center"><input type="text" name="compulsoryInsurance" onfocus="WdatePicker({isShowClear:false,readOnly:true})"/></td>
				</tr>
			</table>
		</div>
	</form>    
